...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:
          // BlocListener<AuthCubit, AuthState1>(
          //   listener: (context, state) {
          //     final error = state.maybeWhen(
          //         error: (user, message) => message, orElse: () => null);
          //
          //     if (error != null) {
          //       showAuthError(
          //           authError:
          //               AuthError(dialogTitle: "An error", dialogText: error),
          //           context: context);
          //     }
          //
          //     final isSuccess =
          //         state.maybeWhen(content: (_) => true, orElse: () => false);
